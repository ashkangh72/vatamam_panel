...
class AuctionRejectNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        sendSms($this->message, $notifiable, NotificationSettingKeyEnum::auction_reject->name);
    }
