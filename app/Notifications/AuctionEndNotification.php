...
class AuctionEndNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function via($notifiable): array
    {
        ...
        return notificationChannels($notifiable, $channels, NotificationSettingKeyEnum::auction_end);
    }
    ...
    {
        sendSms($this->message, $notifiable, NotificationSettingKeyEnum::auction_end->name);
    }
