                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item active">تاریخچه کیف پول وتمام
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <section id="main-card" class="card">
                    <div class="card-header">
                        <h4 class="card-title" title="{{ convert_number($total) . ' تومان' }}">تاریخچه کیف پول وتمام
                            (موجودی: {{ number_format($total) }})</h4>
                    </div>
