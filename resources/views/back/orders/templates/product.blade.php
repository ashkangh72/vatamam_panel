<script id="product-template" type="template/html">
    <div class="row align-items-center order-single-product">
        <div class="col-md-2">
            <img class="w-100 product-image" src="<%= product.image %>" alt="<%= product.title %>">
        </div>
        <div class="col-md-6">
            <div class="mb-1">
                ...
                <div class="mb-1">
                    <select class="form-control price-select">
                        <% product.prices.forEach(function(price){ %>
                            ...
                            <option value="<%= price.id %>" data-price="<%= JSON.stringify(price) %>" data-product="<%= JSON.stringify(product) %>">
                                <% let attcount = 0 %>
            ...
            <del class="text-danger regular-price-container <% if (!product.regular_price) { %> d-none <% } %>"><span class="regular-price"><%= number_format(product.regular_price) %></span></del>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input max="<%= product.cart_max %>" type="number" name="products[<%= productsCount %>][quantity]" class="form-control product-quantity" value="1">
            </div>
        </div>
        <div class="col-md-2">
