...
<div class="row">
    <div class="col-md-6">
        <ul data-default-period="monthly" class="nav nav-pills statics-tab statistics-period" >
            <li class="nav-link" data-period="daily">روزانه</li>
            <li class="nav-link" data-period="weekly">هفتگی</li>
            <li class="nav-link" data-period="monthly">ماهانه</li>
            <li class="nav-link" data-period="yearly">سالانه</li>
        </ul>
    </div>
    <div class="col-md-6">
