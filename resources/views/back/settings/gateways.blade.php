                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <form id="gateway-form" action="{{ route('admin.settings.gateways') }}" method="POST">
                                        ...
                                        @php
                                            $gateway = $gateways->where('key', 'rayanpay')->first();
                                        @endphp
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="rayanpay" type="checkbox" name="gateways[{{ $gateway->id }}][is_active]" {{ $gateway->is_active ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                                                        </span>
                                                        <span class="">درگاه رایان پی </span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-2 form-group">
                                                ...
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr rayanpay"
                                            ...
                                            <div class="col-md-4 form-group">
                                                <label>عنوان</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][name]" class="form-control rayanpay" value="{{ $gateway->name }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label>کد درگاه پرداخت</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][configs][merchantId]" class="form-control ltr rayanpay"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <label>ترتیب نمایش</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr payir"
                                                        value="{{ $gateway->ordering }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <label>ترتیب نمایش</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr behpardakht"
                                                        value="{{ $gateway->ordering }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <label>ترتیب نمایش</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr zarinpal"
                                                        value="{{ $gateway->ordering }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <label>ترتیب نمایش</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr payping"
                                                        value="{{ $gateway->ordering }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <label>ترتیب نمایش</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr idpay"
                                                        value="{{ $gateway->ordering }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <label>ترتیب نمایش</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr sepehr"
                                                        value="{{ $gateway->ordering }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <label>ترتیب نمایش</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr saman"
                                                        value="{{ $gateway->ordering }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
...
@push('scripts')
    <script src="{{ asset('public/back/assets/js/pages/settings/gateways.js') }}?v=2"></script>
@endpush
