                                    ...
                                    <table class="table table-striped mb-0">
                                        <thead>
                                            <tr>
                                                <th>ردیف</th>
                                                <th>عنوان</th>
                                                <th style="white-space: nowrap">شهر فروشگاه</th>
                                                <th style="white-space: nowrap">شهرهای تحت پوشش</th>
                                                <th style="white-space: nowrap">پس کرایه</th>
                                        ...
                                        <tbody>
                                            @foreach ($carriers as $carrier)
                                                <tr>
                                                    ...
                                                    <td>{{ $carrier->title }}</td>
                                                    <td style="white-space: nowrap">{{ $carrier->province->name }} - {{ $carrier->city->name }}</td>
                                                    <td >
