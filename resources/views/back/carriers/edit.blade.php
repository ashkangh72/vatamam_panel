                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="province" data-action="{{ route('provinces.get-cities') }}"  name="province_id" class="form-control">
                                                                        ...
                                                                        @foreach ($provinces as $province)
                                                                            <option value="{{ $province->id }}" {{ $carrier->province->id == $province->id ? 'selected' : '' }}>{{ convertToPersianCharacter($province->name) }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="city" name="city_id" class="form-control">
                                                                        @foreach ($carrier->province->cities as $city)
                                                                            <option value="{{ $city->id }}" {{ $carrier->city->id == $city->id ? 'selected' : '' }}>{{ convertToPersianCharacter($city->name) }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
