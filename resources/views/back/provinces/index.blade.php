                    ...
                    <div class="card-content">
                        @can('carriers.provinces.delete')
                            <div class="card-body">
                                ...
                                <div class="datatable datatable-bordered datatable-head-custom" id="provinces_datatable"
                                    data-action="{{ route('admin.provinces.apiIndex') }}"
                                    data-sortable="{{ route('admin.provinces.sort') }}"></div>
                            </div>
                        @endcan
                    </div>
                </section>
