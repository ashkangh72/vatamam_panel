                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item active">ویرایش اسلاید
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="slide-edit-form"
                                      action="{{ route('admin.slides.update', ['slide' => $slide]) }}">
                                    @csrf
                                    @method('put')
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input type="checkbox" name="published" {{ $slide->is_active ? 'checked' : '' }}>
                                                    ...
                                                    <div class="custom-file">
                                                        <select name="linkable_type" onchange="generateConnectHtml(event)"
                                                            ...
                                                            <option value="category"
                                                                    {{ $slide->linkable_type == 'App\Models\Category' ? 'selected' : '' }} id="category"
...
@push('scripts')
    ...
    <script src="{{ asset('public/back/assets/js/pages/slides/edit.js') }}"></script>
@endpush
