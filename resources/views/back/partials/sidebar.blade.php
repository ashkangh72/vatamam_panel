<div class="main-menu menu-fixed menu-accordion menu-shadow {{ user_option('theme_color') == 'dark' ? 'menu-dark' : 'menu-light' }}"
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @can('users')
                <li
                    class="nav-item has-sub {{ open_class(['admin.users.*', 'admin.wallets.*', 'admin.wallet-checkouts.*']) }}">
                    <a href="#">
                        ...
                        @can('users.index.block')
                            <li class="{{ active_class('admin.users_block.index') }}">
                                <a href="{{ route('admin.users_block.index') }}">
                                    <i class="feather icon-circle"></i>
                                    <span class="menu-item">کاربران بلاک شده</span>
                                </a>
                            </li>
                        @endcan
                    </ul>
                        ...
                        @can('auctions.index')
                            <li class="{{ active_class('admin.auctions.index') }} nav-item">
                                <a href="{{ route('admin.auctions.index') }}">
                                    <i class="feather icon-circle"></i>
                                    <span class="menu-item" style="margin-left: 10px;">لیست مزایده ها</span>
            ...
            @can('transactions')
                <li class="nav-item has-sub {{ open_class(['admin.transactions.*']) }}"><a href="#"><i
                    ...
                    <ul class="menu-content">
                        ...
                        @endcan
                        @can('transactions.mali')
                            <li class="{{ active_class('admin.mali.detail.index') }}">
                                <a href="{{ route('admin.mali.detail.index') }}">
                                    <i class="feather icon-credit-card"></i>
                                    <span class="menu-title"> تراکنش های مالی</span>
                                    @if (auth()->user()->panelNotifies('mali') > 0)
                                        <span class="badge badge badge-primary badge-pill float-right mr-2">
                                            {{ auth()->user()->panelNotifies('mali') }}</span>
                                    @endIf
                                </a>
                            </li>
                        @endcan
                        @can('transactions.payment.index')
                            <li class="{{ active_class('admin.transactions.index') }}">
                                <a href="{{ route('admin.transactions.index') }}">
                                    <i class="feather icon-credit-card"></i>
                                    <span class="menu-title"> تراکنش های درگاه پرداخت</span>
                    ...
                    <ul class="menu-content">
                        ...
                        @can('statistics.users')
                            <li class="{{ active_class('admin.statistics.users') }}">
                                <a href="{{ route('admin.statistics.users') }}"><i class="feather icon-circle"></i><span
            ...
            @if (auth()->user()->level == 'creator')
                <li
                    class="nav-item has-sub {{ open_class(['admin.permissions.*', 'admin.developer.*', 'admin.logs.*']) }}">
                    <a href="#"><i class="feather icon-alert-octagon"></i><span class="menu-title">توسعه
                            دهنده</span><span class="badge badge-danger badge-pill float-right mr-2">creator</span></a>
                    <ul class="menu-content">
