...
@foreach ($plugins as $plugin)
    ...
    @switch($plugin)
        ...
        @case('mapp')
            @push('scripts')
                <script type="text/javascript" src="{{ asset('public/back/app-assets/mapp/js/mapp.env.js') }}"></script>
                <script type="text/javascript" src="{{ asset('public/back/app-assets/mapp/js/mapp.min.js') }}"></script>
            @endpush
        ...
        @case('apexcharts')
            @push('scripts')
                <script src="{{ asset('public/back/app-assets/vendors/js/charts/apexcharts.min.js') }}?v=2"></script>
            @endpush

            @push('styles')
                <link rel="stylesheet" href="{{ asset('public/back/app-assets/vendors/js/charts/apexcharts.css') }}?v=1">
            @endpush
        @break

        @case('combo-tree')
            @push('scripts')
                <script src="{{ asset('public/back/app-assets/plugins/combo-tree/combo-tree.js') }}?v=1"></script>
            @endpush
