                                    ...
                                    <table class="table table-striped mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="white-space: nowrap">تاریخ ارسال</th>
                                        ...
                                        <tbody>
                                            @foreach ($contacts as $contact)
                                                <tr id="contact-{{ $contact->id }}-tr">
                                                    ...
                                                    <td style="white-space: nowrap">{{ tverta($contact->created_at)->format('%d %B %Y') }}</td>
...
@push('scripts')
    <script src="{{ asset('public/back/assets/js/pages/contacts/index.js') }}"></script>
@endpush
