    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                @include('back.faqs.partials.filters')
                ...
                <section id="main-card" class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <div class="datatable datatable-bordered datatable-head-custom" id="faqs_datatable" data-action="{{ route('admin.faqs.apiIndex') }}" data-sortable="{{ route('admin.faqs.sort') }}"></div>
                        </div>
                    </div>
                </section>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    با حذف سوالات متداول دیگر قادر به بازیابی آنها نخواهید بود
                </div>
                <div class="modal-footer">
                    <form action="{{ route('admin.faqs.multipleDestroy') }}" id="faq-multiple-delete-form">
                        @csrf
                        @method('delete')
...
@push('scripts')
    <script src="{{ asset('public/back/assets/js/pages/faqs/index.js') }}"></script>
@endpush
