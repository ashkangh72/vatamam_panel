    ...
    <tbody>
        @foreach($products as $product)
            <tr>
                ...
                @isset($filters['stock'])
                    <td>{{ $product->prices()->sum('stock') }}</td>
                @endisset

                @isset($filters['price'])
                    <td>
                        @if($product->getLowestPrice(true) == $product->getHighestPrice(true))
                            {{ $product->getLowestPrice(true) ?? 'ناموجود' }}
                        @else
                            {{ $product->getLowestPrice(true) .' - '. $product->getHighestPrice(true) }}
                        @endif
                    </td>
                @endisset
                ...
                @isset($filters['publish_date'])
                    <td>{{ tverta($product->publish_date) }}</td>
                @endisset
