                    ...
                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="slider-create-form" action="{{ route('admin.sliders.store') }}"
                                      method="slider">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="first-name-vertical">توضیحات
                                                    ...
                                                    <select class="form-control" name="group">
                                                        @if (config('front.sliderGroups'))
                                                            ...
                                                            @foreach (config('front.sliderGroups') as $sliderGroup)
                                                                <option
                                                                    value="{{ $sliderGroup['group'] }}">{{ $sliderGroup['name'] }} {{ $sliderGroup['size'] }}</option>
                                                            @endforeach
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <select name="link_type" onchange="generateConnectHtml(event)"
                                                            ...
                                                            <option value="product" id="product" data-action="{{route('admin.products.search.title')}}">محصول</option>
                                                            <option value="category" id="category" data-action="{{route('admin.categories.search.title')}}">دسته</option>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                            </div>
...
@push('scripts')
    ...
    <script src="{{ asset('public/back/assets/js/pages/sliders/create.js') }}"></script>
@endpush
