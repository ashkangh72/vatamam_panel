            ...
            <div class="content-body">
                ...
                <section id="main-card" class="card">
                    <div class="card-header">
                        <h4 class="card-title">ایجاد شهر جدید</h4>
                    </div>

                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="city-create-form" action="{{ route('admin.cities.store') }}" data-redirect="{{ route('admin.provinces.index') }}" method="post">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
...
@push('scripts')
    <script src="{{ asset('public/back/assets/js/pages/cities/create.js') }}"></script>
@endpush
