                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb no-border">
                                ...
                                <li class="breadcrumb-item active">ویرایش نقش
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="card-body">
                            <form id="role-create-form" action="{{ route('admin.roles.update', ['role' => $role]) }}">
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">ویرایش نقش</button>
                                    </div>
                                </div>
                            </form>
                        </div>
