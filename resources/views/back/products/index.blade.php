                ...
                <form id="products-export-form" action="{{ route('admin.products.export') }}">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-checkbox custom-checkbox-success">
                                    <input id="export-checkbox-sku" type="checkbox" class="custom-control-input" name="filters[sku]" value="1" checked>
                                    <label class="custom-control-label" for="export-checkbox-sku">sku</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="custom-control custom-checkbox custom-checkbox-success">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-checkbox custom-checkbox-success">
                                    ...
                                    <label class="custom-control-label" for="export-checkbox-stock">موجودی</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="custom-control custom-checkbox custom-checkbox-success">
                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                <div class="form-group">
                                    <label class="col-12" for="">نوع خروجی
