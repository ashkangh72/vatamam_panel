                        ...
                        <div class="form-group">
                            ...
                            <select id="size_type_id" name="size_type_id" class="form-control">
                                ...
                                @foreach ($sizeTypes as $sizeType)
                                    <option data-action="{{ route('admin.size-types.show', ['size_type' => $sizeType]) }}" value="{{ $sizeType->id }}" {{ $product && $product->size_type_id == $sizeType->id ? 'selected' : '' }}>{{ $sizeType->title }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
