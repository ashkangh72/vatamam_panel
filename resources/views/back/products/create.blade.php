                                               ...
                                               <div class="tab-content">
                                                           ...
                                                           <div class="form-body">
                                                               ...
                                                               <div class="row">
                                                                           ...
                                                                           <select class="form-control product-category" name="category_id">
                                                                               @foreach ($categories as $category)
                                                                                   <option
                                                                                       ...
                                                                                       value="{{ $category->id }}"
                                                                                       {{ ($copy_product && $copy_product->category_id == $category->id) ? 'selected' : '' }}>{{ $category->title }}
                                                                                   </option>
                                                                               @endforeach
                                                                           </select>
                                                                       </div>
                                                                   ...
                                                                   <div class="col-md-4 col-12 physical-item">
                                                                       <div class="form-group">
                                                                           <label>انبار</label>
                                                                           <select name="warehouse_id" id="product-warehouse-id" class="form-control" {{ $copy_product && $copy_product->isPhysical() ? 'required' : '' }}>
                                                                               <option value="">انتخاب کنید</option>
                                                                               @foreach ($warehouses as $warehouse)
                                                                                   <option value="{{ $warehouse->id }}" {{ $copy_product && ($copy_product->warehouse_id) ? 'selected' : '' }}>{{ $warehouse->name }}</option>
                                                                               @endforeach
                                                                           </select>
                                                                       </div>
                                                                   </div>
                                                                   ...
                                                                   <div class="col-md-4 col-12 physical-item">
                                                                       <div class="form-group">
                                                                           <label>وزن</label>
                                                                           <input type="number" class="form-control" name="weight" value="{{ $copy_product ? $copy_product->weight : 1 }}">
                                                                       </div>
                                                                   </div>
                                                                   <div class="col-md-4 col-12 physical-item">
                                                                       <div class="form-group">
                                                                   ...
                                                                   <div class="col-md-4 col-12">
                                                                       <div class="form-group">
                                                                           ...
                                                                           <input type="number" class="form-control" name="cart_max" value="{{ $copy_product ? $copy_product->cart_max : NULL }}" min="1">
                                                                       </div>
                                                                   </div>
                                                                   <div class="col-md-4 col-12">
                                                                       <div class="form-group">
                                                                           <label>کمترین تعداد مجاز در هر سفارش</label>
                                                                           <input type="number" class="form-control" name="cart_min" value="{{ $copy_product ? $copy_product->cart_min : NULL }}" min="1">
                                                                       </div>
                                                                   </div>
                                                                   ...
                                                                   <div class="col-md-4 col-12">
                                                                       <div class="form-group">
                                                                           ...
                                                                           <input type="text" class="form-control" name="sku" value="{{ $copy_product ? $copy_product->sku : NULL }}">
                                                                       </div>
                                                                   </div>
                                                   ...
                                                   <div class="tab-pane" id="product-prices-tab" role="tabpanel" aria-labelledby="product-prices-tab-nav">
                                                       <div class="row">
                                                           ...
                                                           <div class="form-group col-md-3 col-12">
                                                               ...
                                                               <select class="form-control price-attribute-select" id="priceSizeId" multiple>
                                                                   <option disabled>کلید Ctrl را نگه دارید</option>
                                                       ...
                                                       <div id="productPrices">
                                                           @if ($copy_product && $copy_product->isPhysical() && $copy_product->prices->count() > 0)
                                                               @php
                                                               ...
                                                               @if(count($colorAttributes) > 0)
                                                                   @foreach($colorAttributes as $colorAttributeName => $colorAttributeId)
                                                                       <div class="row single-color" id="singleColor-{{ $colorAttributeId }}">
                                                                           <div class="col-md-12" >
                                                                               <label class="badge badge-light" id="priceRowLabel">{{ 'قیمت های رنگ '.$colorAttributeName }}</label>
                                                                           ...
                                                                           @foreach ($copy_product->prices()->whereHas('get_attributes', function ($attributes) use ($colorAttributeId) {
                                                               ...
                                                               <div class="row">
                                                                   ...
                                                                   <div class="col-md-6">
                                                                       <fieldset class="form-group">
                                                                           ...
                                                                           <input type="text" name="tags" class="form-control tags" value="{{ $copy_product ? $copy_product->getTags : '' }}">
                                                                       </fieldset>
                                                                   </div>
                                                   ...
                                                   <div class="tab-pane overflow-hidden" id="tabProductImage" role="tabpanel" aria-labelledby="productImageTab">
                                                           ...
                                                           <div class="col-md-3">
                                                               <fieldset class="form-group">
                                                                   ...
                                                                   <div class="custom-file">
                                                                       ...
                                                                       <label class="custom-file-label" for="secondImage"></label>
                                                                       <p><small>بهترین اندازه <span class="text-danger">{{ config('front.imageSizes.productImage') }}</span> پیکسل میباشد.</small></p>
                                                                   </div>
                                                               </fieldset>
                                                           </div>
                                                       ...
                                                       <div class="row" id="attributePictureRows"></div>
                                                   </div>
                                                       ...
                                                       <div class="col-md-12">
                                                           <div class="form-body">
                                                               <div class="form-group row">
                                                                   <label for="recommendedProductsSearch" class="col-sm-2 control-label">محصول</label>
                                                                   <div class="col-sm-4">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">ایجاد محصول</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        let groupCount = {{ $copy_product ? $copy_product->specificationGroups->unique()->count() : '0' }};
        let specificationCount = {{ $copy_product ? $copy_product->specifications->unique()->count() : '0' }};
        ...
        let specifications_type_first_change = {{ $copy_product ? 'true' : 'false' }};

        let priceCount = {{ $copy_product ? $copy_product->prices->count() : '0' }};
        let filesCount = 0;
