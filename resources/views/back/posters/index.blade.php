                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item active">لیست پوسترها</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-body" id="main-card">
                @if (config('general.posterGroups'))
                    @foreach (config('general.posterGroups') as $posterGroup)
                        @include('back.partials.posters', [
                            'posters' => $posters->where('group', \App\Enums\PosterGroupEnum::find($posterGroup['group'])),
                            'group' => $posterGroup['group'],
                            'title' => $posterGroup['name']
                            ]
                        )
                    @endforeach
                @endif
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    با حذف پوستر دیگر قادر به بازیابی آن نخواهید بود
                </div>
                <div class="modal-footer">
                    <form action="#" id="poster-delete-form">
                        @csrf
                        @method('delete')
...
@push('scripts')
    ...
    <!-- Page Js codes -->
    <script src="{{ asset('back/assets/js/pages/posters/index.js') }}"></script>
@endpush
