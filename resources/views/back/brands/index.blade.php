                                            ...
                                            @foreach ($brands as $brand)
                                                <tr id="brand-{{ $brand->id }}-tr">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <button type="button" data-brand="{{ $brand->id }}" data-id="{{ $brand->id }}" class="btn btn-danger mr-1 waves-effect waves-light btn-delete"  data-toggle="modal" data-target="#delete-modal">حذف</button>
                                                    </td>
                                                </tr>
                                            @endforeach
