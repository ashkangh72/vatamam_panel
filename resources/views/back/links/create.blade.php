                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item active">ایجاد لینک
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="link-create-form" action="{{ route('admin.links.store') }}" method="link">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label>لینک </label>
                                                    <input type="text" class="form-control link-link ltr" name="link">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="link_group_id">
                                                        @foreach($groups as $group)
                                                            <option value="{{ $group['key'] }}">{{ option('link_groups_' . $group['key'], $group['name']) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-right">
                                                <button type="submit" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">ایجاد لینک </button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
