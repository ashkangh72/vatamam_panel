                ...
                @if($backups->count())
                    <section class="card">
                        <div class="card-header">
                            <h4 class="card-title">لیست بکاپ ها
                                @if(config('general.ftp.active', false))<span class="badge badge-success badge-pill">سرور ftp</span>@endif
                            </h4>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($backups->sortByDesc('date') as $backup)
                                                <tr id="backup-{{ $backup['name'] }}-tr">
                                                    <td class="ltr" style="white-space: nowrap">{{ $backup['name'] }}</td>
                                                    <td class="ltr" style="white-space: nowrap">{{ tverta($backup['date']) }}</td>
