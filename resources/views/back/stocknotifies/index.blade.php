                                            ...
                                            @foreach ($stocknotifies as $stock_notify)
                                                ...
                                                <tr id="stock_notify-{{ $stock_notify->id }}-tr">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ Route::has('front.products.show') ? route('front.products.show', ['product' => $stock_notify->product]) : '' }}" target="_blank"><i class="feather icon-external-link"></i></a>
                                                        <br>
                                                        {{ $stock_notify->price ? $stock_notify->price->getAttributesName() : '' }}
                                                    </td>
