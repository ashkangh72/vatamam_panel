...
@section('container')
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_hostname" value="{{ old('database_hostname') ?: '127.0.0.1' }}" id="database_hostname" placeholder="{{ trans('installer_messages.environment.wizard.form.db_host_placeholder') }}" />
                ...
                <div class="buttons">
                    <button id="submit-form" class="button">
        ...
        <div id="installing-message" class="alert text-center" style="display: none;">
            <span><i class="fa fa-refresh fa-spin"></i></span>
            <p>
                <strong>
                    لطفا تا اتمام نصب صبر کنید...
                </strong>
            </p>
            <p>عملیات نصب ممکن است تا یک دقیقه طول بکشد</p>
        </div>
    </div>
@endsection
