    ...
    var options = {
        ...
        columns: [{
            ...
            },
            {
                ...
                autoHide: false,
                template: function(row) {
                    return '<button data-toggle="modal" data-target="#delete-modal" data-action="' + row.links.unblock + '" class="btn btn-danger waves-effect waves-light btn-unblock">انبلاک کردن</button>\
